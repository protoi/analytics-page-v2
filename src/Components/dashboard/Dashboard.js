...
function DashboardContent({ substance_to_render }) {
      ...
      <Box sx={{ display: "flex" }}>
        ...
        <AppBar position="absolute" open={open}>
          ...
          >
            ...
            {/* TODO: {Can put a time selector over here maybe ? } */}
...
const router = createBrowserRouter([
  {
    path: "/",
    element: <DashboardContent substance_to_render={"TIME_MAPPING"} />,
  },
  {
    path: "/intent",
    element: <DashboardContent substance_to_render={"INTENT_MAPPING"} />,
  },
  {
    path: "/onboarding",
    element: <DashboardContent substance_to_render={"ONBOARDING"} />,
  },
  {
    path: "/aboutus",
    element: <DashboardContent substance_to_render={"ABOUTUS"} />,
  },
]);
